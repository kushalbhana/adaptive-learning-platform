...
import { SignupSchema, SignupFormValues } from "@/lib/zodTypes"
...
export function SignupForm() {
  ...
  return (
    <div className="max-w-md w- mx-auto rounded-none md:rounded-2xl p-2 md:p-2 shadow-input bg-white dark:bg-slate-950 md:w-full">
      <h2 className="font-bold text-xl text-neutral-800 dark:text-neutral-200">Signup</h2>
      <p className="text-neutral-600 text-sm max-w-sm mt-2 dark:text-neutral-300">
        Signup to continue winning
      </p>
